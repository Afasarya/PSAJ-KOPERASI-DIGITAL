              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {transaction.payment_method ? transaction.payment_method.name : 'Unknown'}
                  </span>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                {transaction.user ? (
                  ...
                  <div className="flex items-center gap-2">
                    <UserIcon className="h-4 w-4 text-muted-foreground" />
                    <span className="italic text-muted-foreground">Kasir tidak ditemukan</span>
                  </div>
                )}
              </CardContent>
            </Card>
                    ...
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        {item.product ? (
                          ...
                          <div className="text-xs text-muted-foreground">No product data</div>
                        )}
                      </TableCell>
