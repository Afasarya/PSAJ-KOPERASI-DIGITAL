...
import { 
  ...
  CreditCard, 
  FileText, 
  Folder, // Tambahkan import Folder
  Home, 
  LogOut, 
  Menu, 
  Package, 
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children, title }) => {
  ...
  const navigation = [
    ...
    { name: 'Kategori', href: route('admin.categories.index'), icon: Folder }, // Tambahkan menu Kategori
    { name: 'Produk', href: route('admin.products.index'), icon: Package },
    { name: 'Inventaris', href: route('admin.inventory.index'), icon: Box },
    { name: 'Stock Opname', href: route('admin.stock-opname.index'), icon: Clipboard },
    { name: 'Transaksi', href: route('admin.transactions.index'), icon: ShoppingCart },
